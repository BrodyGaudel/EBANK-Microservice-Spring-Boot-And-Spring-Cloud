...
public interface XecdApiService {
	 ...
	 */
	AccountInfoResponse getAccountInfo(String accountId, String apiKey) throws XecdApiException, ClientProtocolException, URISyntaxException, IOException;
	 ...
	 * @throws URISyntaxException 
	 */
	AccountInfoResponse getAccountInfo() throws XecdApiException, URISyntaxException, IOException;
